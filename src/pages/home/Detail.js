    ...
    return (
        <>
            ...
            <meta name="description"
                  content="Thuê ngay Rabbit nee 🐰🐰, nhận all game, sv Na, Naraka lĩnh vực PUBG PC,Đấu Trường Chân Lý,Liên Minh Huyền Thoại,Liên Quân Mobile,Liên Minh Tốc Chiến,Valorant,GTA V,Dota 2,CSGO,Naraka Bladepoint,Tâm Sự, chỉ với 75000đ/h!"/>
            <meta name="keywords"
                  content="Thuê ngay Rabbit nee 🐰🐰, nhận all game, sv Na, Naraka lĩnh vực PUBG PC,Đấu Trường Chân Lý,Liên Minh Huyền Thoại,Liên Quân Mobile,Liên Minh Tốc Chiến,Valorant,GTA V,Dota 2,CSGO,Naraka Bladepoint,Tâm Sự, chỉ với 75000đ/h!"/>
            ...
            <meta property="og:image"
                  content="https://playerduo.net/api/upload-service/thumbs/medium/029f1f12-4fb8-4b21-8171-ca7bf863e2f8__182c6540-4388-11ee-a657-a54d6be1d46a__player_avatar.jpg"/>
                        ...
                        <div className="player-profile-left-wrap col-md-3">
                            ...
                            <div className="social-icon">
                                <div className="icon-wrap user-page">
                                    {userDetail.account &&
                                    <a href={userDetail.account.avatar} target="_blank" rel="">
                            ...
                            <div className="member-since">
                                ...
                                <span>{userDetail.dateCreate}</span>
                            </div>
                        </div>
                        <div className="player-profile-right-wrap col-md-3 col-md-push-6">
                            <div className="right-player-profile">
                                <p className="price-player-profile">{userDetail.price}.000 VND</p>
                                <div className="rateting-style"><i className="fas fa-star"/><i className="fas fa-star"/><i
                                    className="fas fa-star"/><i className="fas fa-star"/><i
                                    className="fas fa-star-half-alt"/>&nbsp;<span>352 <span>Đánh giá</span></span>
                                </div>
                                <div className="text-center">
                                    <button className="btn-my-style red">Thuê</button>
                                    <button className="btn-my-style white">Donate</button>
                                    <button className="btn-my-style white"><i className="fas fa-comment-alt"/>Chat
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="nav-player-profile row">
                                    ...
                                    <div className="col-md-3 col-xs-6">
                                        ...
                                        <div className="item-nav-value"><i className="fas fa-microphone"/></div>
                                    </div>
                                </div>
                                <hr/>
                                    ...
                                    <div className="album-of-player">
                                        <div>
                                            {image && image.map(image => (
                                                <a style={{borderRadius:"10px"}} href={image.img}>
                                ...
                                <div id="top-donate">
                                    <ul role="tablist" className="nav nav-tabs">
                                        <li role="presentation" className="active"><a id="top-donate-tab-1" role="tab"
                                                                                      aria-controls="top-donate-pane-1"
                                                                                      aria-selected="true" href="#">Top
                                            Donate</a></li>
                                        <li role="presentation" className><a id="top-donate-tab-2" role="tab"
                                                                             aria-controls="top-donate-pane-2"
                                                                             tabIndex={-1} aria-selected="false"
                                                                             href="#">Top Donate Tháng</a></li>
                                    </ul>
                                    <div className="tab-content">
                                        <div id="top-donate-pane-1" aria-labelledby="top-donate-tab-1" role="tabpanel"
                                            ...
                                            <div className="mg-24">
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-6">Lỗi</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span
                                                            className="name-player-review color-vip-14">Hoàng Mjn™️</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-10">Mlem</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span
                                                            className="name-player-review color-vip-14">Lê Đức Nam 1</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-10">- ATM</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-14">Chaien</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span
                                                            className="name-player-review color-vip-10">Loli Tử Nghiên</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-6">OFF</span>
                                                    </div>
                                        ...
                                        <div id="top-donate-pane-2" aria-labelledby="top-donate-tab-2" role="tabpanel"
                                            ...
                                            <div className="mg-24">
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-6">Happybirthdayy me</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-6">S1mple09</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        <div className="avt avt-xs"><img
                                                            src="../resources/raw/avatar23.png" className="avt-img"
                                                            alt="PD"/><img src="../resources/raw/11.png"
                                                                           className="vip-avatar undefined" alt="PD"
                                                                           style={{height: '17px', width: '17px'}}/>
                                                        </div>
                                                        <span className="name-player-review color-vip-10">Cam</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span
                                                            className="name-player-review color-vip-1">Trần Huy Tùng</span>
                                                    </div>
                                                ...
                                                <div className="top-donate-player row">
                                                    ...
                                                    <div className="col-xs-7">
                                                        ...
                                                        <span className="name-player-review color-vip-1">Name</span>
                                                    </div>
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    src="../resources/raw/4.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/traiyeumeo">
                                                    <p className="name-player-review color-vip-1">Hữu Lulu</p></a>
                                                    <p className="time-player-review"><span>20:29:56 29/8/2023</span>
                                                    </p></div>
                                                <div className="review-rating">
                                                    <div className="rateting-style"><i className="fas fa-star"/><i
                                                        className="fas fa-star"/><i className="fas fa-star"/><i
                                                        className="fas fa-star"/><i className="fas fa-star"/>&nbsp;
                                                    </div>
                                                    <span
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/14-1.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/page61d7d8a16afb847ad39c91bf">
                                                    <p className="name-player-review color-vip-14">Hoàng Mjn™️</p></a>
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    src="../resources/raw/6be09225-9c6a-4334-a0f3-5bb74406f487__8121abb0-33ec-11ee-a657-a54d6be1d46a__page_avatar.jpg"
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/10-1.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/anhtamheone">
                                                    <p className="name-player-review color-vip-10">- ATM</p></a>
                                                ...
                                                <p className="content-player-review">Đau để trưởng thành</p></div>
                                        </div>
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                            ...
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                    ...
                                                    <p className="time-player-review"><span>04:59:18 3/8/2023</span></p>
                                                </div>
                                                <div className="review-rating">
                                                    <div className="rateting-style"><i className="fas fa-star"/><i
                                                        className="fas fa-star"/><i className="fas fa-star"/><i
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/3.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/minhquann">
                                                    <p className="name-player-review color-vip-1">Minh Quân</p></a>
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/1-1.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/page5e3b1230aec0db0a2f982738">
                                                    <p className="name-player-review color-vip-1">Anh Tuan</p></a>
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/7-1.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/page5b99fcf16ccbeb40c6674c50">
                                                    <p className="name-player-review color-vip-6">noel một mình</p></a>
                                                    <p className="time-player-review"><span>23:17:27 1/6/2023</span></p>
                                                </div>
                                                <div className="review-rating">
                                                    <div className="rateting-style"><i className="fas fa-star"/><i
                                                        className="fas fa-star"/><i className="fas fa-star"/><i
                                                ...
                                                <p className="content-player-review">Thủy no1 =))</p></div>
                                        </div>
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img src="../resources/raw/avatar9.png"
                                            ...
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                    ...
                                                    <p className="name-player-review color-vip-1">văn Phước</p></a>
                                        ...
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/5.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/minh07092001">
                                                    <p className="name-player-review color-vip-1">M 💔</p></a>
                                                ...
                                                <p className="content-player-review">bạn này đáng iu nè</p></div>
                                        </div>
                                        <div className="full-size">
                                            <div className="review-image-small">
                                                <div className="avt-rank avt-md"><img
                                                    ...
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                                    src="../resources/raw/2-1.png" className="rank-1-15 rank-img"
                                                    alt="PlayerDuo"/></div>
                                            </div>
                                            <div className="wrapper-content-rating">
                                                <div className="review-content"><a target="_blank"
                                                                                   href="https://playerduo.net/page600ce889399d5e2bc1ed8e5d">
                                                    <p className="name-player-review color-vip-1">Haro</p></a>
                                                    <p className="time-player-review"><span>13:14:44 3/5/2023</span></p>
                                                </div>
                                                <div className="review-rating">
                                                    <div className="rateting-style"><i className="fas fa-star"/><i
                                                        className="fas fa-star"/><i className="fas fa-star"/><i
                                                ...
                                                <p className="content-player-review">sap xep lai thoi gian ngu nghi
                                                    nhe</p></div>
                                        </div>
                                    </div>
                                    <div className="col-md-12">
                                        <div className="page_account"><p className="active">1</p>
                                            ...
                                            <p className>4</p>
                                            <p className>5</p>
                                            <p className="active" style={{cursor: 'auto'}}>1/36</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
