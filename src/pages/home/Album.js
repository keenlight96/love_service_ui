...
function Album() {
    ...
    useEffect(() => {
        axios.get("http://localhost:8080/images/albumImageCCDV")
            .then(response => {
                                ...
                                <div className="player-albums">
                                    <div className="col-md-12">
                                        <div>
                                            ...
                                            <button type="submit" onClick={uploadFile} className="btn-upload">Enter
                                            </button>
                                        </div>
                                    </div>
                                    <br/>
                                    {imageUrls && imageUrls.map((url) => (
                                        <div className="col-md-3">
                                            <p>
                                                <img style={{width: "100%", height: "250px", borderRadius: "10px"}}
                                                     src={url}/>
                                            </p>
                                        </div>
                                    ))}
