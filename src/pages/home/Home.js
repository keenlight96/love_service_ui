...
import {getCCDVProperGender, getNewestCCDVs, getSupplyByUserID} from "../../service/CCDVsService";
                    ...
                    <div className="home-flex">
                        ...
                        <div className="home-flex-content">
                                ...
                                <div className="slide extend-box">
                                    <div className="global-chat">
                                        <div id="global-chat" className="global-chat-display">
                                            <div>
                                                <div className="text-center"><i className="fa fa-spinner fa-spin"/>
                                                </div>
                                                <div className="global_message__item media">
                                                    <div className="media-left"><a target="_blank"
                                                                                   href="https://playerduo.net/cheneiiiv">
                                                        <div className="avt-rank avt-sm"><img
                                                            ...
                                                            src="../resources/raw/7.png" className="rank-1-15 rank-img"
                                                            alt="PlayerDuo"/></div>
                                                    </a></div>
                                                    <div className="media-body"><p className="chat-name"><strong
                                                        className="name-player-review color-vip-6"><span
                                                        className="cursor-pointer">VyVy </span> </strong> : </p>
                                                ...
                                                <div className="global_message__item media">
                                                    <div className="media-left"><a target="_blank"
                                                        ...
                                                        <div className="avt-rank avt-sm"><img
                                                            ...
                                                            className="avt-1-15 avt-img" alt="PD"/><img
                                                            src="../resources/raw/9.png" className="rank-1-15 rank-img"
                                                            alt="PlayerDuo"/></div>
                                                    </a></div>
                                                    <div className="media-body"><p className="chat-name"><strong
                                                        className="name-player-review color-vip-6"><span
                                                        className="cursor-pointer">Baby Tis </span>
                                                    </strong><i className="fas fa-check-circle"/> : </p>
                                                        <p className="mess-global"><a target="_blank"
                                                                                      href="https://playerduo.net/betis"
                                                                                      className="link">betis</a> nhận
                                                            duo liên quân , pubgmb
                                                ...
                                                <div className="global_message__item media">
                                                    <div className="media-left"><a target="_blank"
                                                        ...
                                                        <div className="avt-rank avt-sm"><img
                                                            ...
                                                            className="avt-1-15 avt-img" alt="PD"/><img
                                                            src="../resources/raw/10.png" className="rank-1-15 rank-img"
                                                            alt="PlayerDuo"/></div>
                                                    </a></div>
                                                    <div className="media-body"><p className="chat-name"><strong
                                                        className="name-player-review color-vip-10"><span
                                                        className="cursor-pointer">Janny trader - ng chơi hệ LHD ✨ </span>
                                                    </strong><i className="fas fa-check-circle"/> : </p>
                                                        <p className="mess-global">trade pld, bán steamcode sll ib là
                                                            onl</p></div>
                                                </div>
                                                <div/>
                                            </div>
                                        </div>
                                        <div className="form-group"><span className="input-group"><input
                                            placeholder="Enter để gửi tin nhắn!" maxLength={255} type="text"
                                            id="formChatText" className="form-control" defaultValue/><p
                                            className="send-chat"><i className="fas fa-paper-plane"/></p><span
                                            className="scope-icon input-group-addon"/></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="action__box">
                                <div className="styles-module_sliderBase__swkx1 action__box--carousel"
                                     data-testid="carousel">
                                    <div data-testid="sliderList" className="styles-module_slider__o0fqa">
                                        <div className="action__box--list">
                                            <div className="box-item create"><img src="../resources/raw/avatar6.png"
                                                                                  className alt="PD"
                                        ...
                                        <div className="action__box--list">
                                            <div className="box-item"><img
                                                src="../resources/raw/e49ffbe1-9391-4177-98ee-c7ac8c7ad135__a5b80762-5e2c-40d2-a860-ec358a4a5dbd__post_video.jpg"
                                                className alt="PD" id="avt-img-reponsiver"/>
                                                <div className="box-item-label"><p><i className="far fa-eye"/> 10</p>
                                                </div>
                                            </div>
                                            <div className="player-name">
                                                <div className="avt-rank avt-sm"><img
                                                    src="../resources/raw/e49ffbe1-9391-4177-98ee-c7ac8c7ad135__fe79ec80-b751-11ec-ba81-7bfd4ef70d64__page_avatar.jpg"
                                                    className="avt-1-15 avt-img" alt="PD"/><img
                                        ...
                                        <div className="action__box--list">
                                            <div className="box-item"><img
                                                src="../resources/raw/f9e96a5f-cc17-49ca-9582-30b97da6eac1__84d6d119-03ff-453d-8c75-63a7aafe557e__post_video.jpg"
                                                className alt="PD" id="avt-img-reponsiver"/>
                                                <div className="box-item-label"><p><i className="far fa-eye"/> 32</p>
                                                </div>
                                            </div>
                                            <div className="player-name">
                                                <div className="avt-rank avt-sm"><img
                                                    src="../resources/raw/f9e96a5f-cc17-49ca-9582-30b97da6eac1__1a4d2da0-4270-11ee-a657-a54d6be1d46a__page_avatar.jpg"
                                                    className="avt-1-15 avt-img" alt="PD"/></div>
                                                <p>Hà Minh Thanh</p></div>
                                        </div>
                                        <div className="action__box--list">
                                            <div className="box-item"><img
                                                src="../resources/raw/df2e4657-c62d-4a9a-b21a-2302983ebb17__1ee7059e-1e2a-45ce-a271-a2980603fb39__post_video.jpg"
                                                className alt="PD" id="avt-img-reponsiver"/>
                                                <div className="box-item-label"><p><i className="far fa-eye"/> 85</p>
                                                </div>
                                            </div>
                                            <div className="player-name">
                                                <div className="avt-rank avt-sm"><img
                                                    src="../resources/raw/df2e4657-c62d-4a9a-b21a-2302983ebb17__dd30a020-4655-11ee-a657-a54d6be1d46a__page_avatar.jpg"
                                                    className="avt-1-15 avt-img" alt="PD"/></div>
                                                <p>XynXynhh</p></div>
                                        </div>
                            ...
                            <div className="list-player">
                                ...
                                <div className="box hot-player">
                                    <header className="title-header hot"><h5 className="title-header-left">HOT
                                        PLAYERS</h5>
                                        <p className="title-header-right"><span>Làm mới</span><i
                                            className="fas fa-sync false"/></p>
                                    </header>
                                            ...
                                            <div className="player-information-card-wrap">
                                                <div className="player-avatar">
                                                    <a target="_blank" href="/ngocngayngohihihehe">
                                                        <img
                                                            src="https://playerduo.net/api/upload-service/images/a0b07166-1e65-4e77-a651-b2fef639aa86__25eed2b0-417d-11ee-a657-a54d6be1d46a__player_avatar.jpg"
                                                            className alt="PD" id="avt-img-reponsiver"/>
                                                    </a>
                                                    <a target="_blank" className="player-price"
                                                       href="/ngocngayngohihihehe">69,000 đ/h</a>
                                                </div>
                                                <a target="_blank" className="player-information"
                                                   href="/ngocngayngohihihehe">
