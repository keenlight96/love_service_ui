                    ...
                    <div>
                        {
                            images && images.map((item, key) => {
                                if (key < 2) {
                                    return (
                                        <a style={{display: 'block', borderRadius:'5px'}} key={key} onClick={() => toggleModal()}>
                                ...
                                if (key == 2) {
                                    return (
                                        <>
                                            <a style={{borderRadius:'5px'}} onClick={() => toggleModal()}>
                                                <img style={{height:"100%", width:"100%"}} src={item.img} className alt="" />
                                                <div className="fadeDiv" style={{borderRadius:'5px'}}><span style={{fontFamily: 'Arial'}}>+{images.length - 2}</span></div>
                                            </a>
